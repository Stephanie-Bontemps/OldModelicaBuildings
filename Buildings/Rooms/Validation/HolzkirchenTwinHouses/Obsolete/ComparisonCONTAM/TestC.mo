within Buildings.Rooms.Validation.HolzkirchenTwinHouses.Obsolete.ComparisonCONTAM;
model TestC "Test C carried on Dymola and CONTAM"
  ...
  Obsolete.N2HouseModel1 N2House(
    ...
    NomFichierBouVenHeaCoo=
        "D:/Berkeley/Berkeley - IEA58/N2BouVenHeaCooTestCGI.txt",
  ...
  BoundaryConditions.WeatherData.ReaderTMY3 weaDat(
    ...
    winDir=0,
    filNam="D:/Berkeley/Berkeley - IEA58/Holzkirchen_TestCGI_TMY3.mos")
