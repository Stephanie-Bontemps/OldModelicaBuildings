...
block ReaderTMY3bis
  "Reader for TMY3 weather data with new calculation for direct normal radiation from global and diffuse horizontal radiations"
...
protected
  ...
  BoundaryConditions.WeatherData.BaseClasses.ConvertRadiation conDirNorRad
...
equation
  ...
  elseif  HSou == Buildings.BoundaryConditions.Types.RadiationDataSource.Input_HGloHor_HDifHor then
      Buildings.Rooms.Validation.HolzkirchenTwinHouses.BaseClasses.smoothMaxNew(x1=(cheGloHorRad.HIn -cheDifHorRad.HIn)/cos(zenAng.zen), x2=epsCos, comp=cos(zenAng.zen), deltaX=0.1*epsCos) = HDirNor_in_internal
