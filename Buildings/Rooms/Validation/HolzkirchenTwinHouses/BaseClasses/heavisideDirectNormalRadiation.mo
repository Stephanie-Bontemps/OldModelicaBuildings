...
function heavisideDirectNormalRadiation
  "Function with Heaviside function to avoid impossible values for the direct normal radiation"
...
end heavisideDirectNormalRadiation;
